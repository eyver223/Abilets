...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 07 2022 г., 20:10
...
(5, 'Северный Ветер', '2978.00', 1, 2, '2022-12-30 18:40:00', '02:40:00'),
(8, 'Белавиа', '6750.00', 2, 5, '2022-12-30 19:58:07', '10:40:07');
...
--
ALTER TABLE `Bilets`
  MODIFY `Bilets_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `CountryCity`
  MODIFY `CountryCity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `Country`
  ADD CONSTRAINT `country_ibfk_1` FOREIGN KEY (`CountryCity_id`) REFERENCES `CountryCity` (`CountryCity_id`) ON DELETE CASCADE;
